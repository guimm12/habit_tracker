...
* @returns {any}
*/
export function create_item(id, name) {
    const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.create_item(id, ptr0, len0);
...
* @returns {any}
*/
export function read_item(id) {
    const ret = wasm.read_item(id);
    return takeObject(ret);
}
...
* @returns {any}
*/
export function update_item(id, name) {
    const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.create_item(id, ptr0, len0);
    return takeObject(ret);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_alert_168638bda6694e21 = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('habit_tracker_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
